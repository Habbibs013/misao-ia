        ...
        alternativas: [
            {
                ...
                afirmacao: ["Você demonstra foco prioritário na proteção da fauna viva e na preservação do equilíbrio dos ecossistemas.",
                            "Você coloca a defesa da vida selvagem e a preservação da natureza no topo das suas prioridades."
                ]
                        },
            {
                ...
                afirmacao: ["Você valoriza a salvaguarda da história natural brasileira e o combate ao saque do patrimônio científico.",
                            "Tom formal: Sua atuação evidencia o compromisso com a preservação do patrimônio natural brasileiro e o combate à exploração indevida da ciência nacional."
                ]
                        }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: ["Sua atuação busca soluções práticas de resgate, fiscalização e devolução das espécies à natureza.",
                         "Pauta-se pela execução de ações estratégicas voltadas ao resgate, controle fiscalizador e restauração da vida selvagem no ecossistema."
                ]
                        },
            {
